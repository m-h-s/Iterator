...
public class Main {
			...
			throws FileNotFoundException 
	{
		 ...
		 * 
		 * A contact can be deleted directly by an external object (i.e.; Main), negating Open-Closed Principle.
		 */
		
		/*
		 * Note that we can write the following for each loop because ArrayList class implements Iterable interface.
		 * 
		 */
